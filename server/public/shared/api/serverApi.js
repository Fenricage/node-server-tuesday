...
class ServerApiClass {
  ...
  r = (url, extra = {}, context) => {
    ...
    return new Promise((resolve, reject) => {
      console.log('\x1b[36m', 'this.headers' , this.headers, '\x1b[0m');
      axios({
        url,
        // headers,
        ...extra,
...
const test = new ServerApiClass(endpoints);
test.getApi().articles.getAll()
  .then(articles => console.log('\x1b[36m', '------------------------WODJ' , '\x1b[0m'))
